...
// 'UDDER', 'VOWEL', 'QUIRK', 'QUEUE', 'MAGIC', 'PANIC', 'ALTER', 'BOUTS', 'NEXUS', 'GRAPE', 'MOURN', 'EPOCH', 'SCORN',
// 'SALAD', 'COMFY', 'UNZIP', 'LOFTY', 'SCREW', 'PRUNE', 'JOYED', 'LEMON', 'NOTED', 'SPOIL', 'TAXED', 'MAXED', 'GRASS',
// 'FROTH', 'LOOPY', 'EIGHT', 'LLAMA', 'CLOSE', 'FORUM', 'BURNT', 'SHIFT', 'ENTER', 'SCARE', 'RESIN', 'STORM', 'CREAM',
...
const smallerWordTest = ['MANGO', 'SOOTH', 'SPANK', 'PUNCH', 'CLOWN', 'ORDER'];
