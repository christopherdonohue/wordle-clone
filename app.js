...
const POTENTIAL_WORDS = [
  'SPARK','MANGO','SPLAT','TOUCH','CLOWN','HAPPY','TOWEL','ALPHA','ATONE','BAYOU', 'MOVIE','MAKES','SKATE','OOZES', 'SPEAR','BOARD','BORED','CLAMP',
  'NORTH', 'OPERA','CRATE','GREAT','FAITH','FORTH', 'LUNCH', 'MORAL', 'WATER', 'ROGUE', 'GLOOM', 'SAPPY', 'ORDER', 'HARDY', 'STOUT', 'EERIE', 'PURSE','CURSE',
  'CHORD','NAKED','WRATH', 'KNEEL', 'GNOME', 'EXTRA', 'TOXIC','HEAVE','MOTOR', 'YEARN', 'DRAWN', 'ULTRA', 'POLAR', 'LUCKY', 'JELLY', 'KOALA', 'EVENT', 'DELTA',
  'HAZEL', 'PRIZE', 'FUNKY', 'KNOCK', 'MOCHA', 'YACHT', 'ADMIN', 'AGONY', 'SATIN', 'SAUCE', 'CARVE', 'COAST', 'VALUE', 'VIDEO', 'UNDER', 'SOUND', 'CLOUD', 'MONEY',
  'TRASH', 'BEING', 'VIRUS', 'HOARD', 'SLACK', 'NURSE', 'LOCAL', 'LADLE', 'SMART', 'SHARK', 'CRAZY', 'DAISY', 'TRAIN', 'ARRAY', 'CRUMB', 'CLOCK', 'SWARM', 'REACT',
  'APPLE', 'MELON', 'BLANK', 'CANOE', 'REFER', 'FLAME', 'STOCK', 'WHILE', 'WEIGH', 'POUND', 'LAZER', 'SORRY', 'DEVIL', 'DELVE', 'MIGHT', 'SPITE', 'LIGHT', 'RIGHT'
];
//prettier-ignore
const POTENTIAL_WORDS_TWO = ['HONOR','TIGHT','ABODE','WHARF','SOOTH','CRAMP','SPACE', 'ROUGH', 'FIFTH', 'SIXTH','DROWN','ONION', 'NOISE', 'JADED', 'PANTS',
  'VENUS','GRAPH', 'MORPH', 'SWORD', 'METER', 'NORSE','UDDER','VOWEL','QUIRK','QUEUE','MAGIC','PANIC','ALTER','BOUTS','NEXUS','GRAPE','MOURN',
